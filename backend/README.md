...
## Project Structure
    ...
    ├── testapiautostoryboa_73052  # Django project configurations
...
1. Clone this repo and `cd testapiautostoryboa_73052`
...
2. Clone this repo and `cd testapiautostoryboa_73052`
